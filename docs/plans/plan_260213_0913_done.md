...
**File:** `src/Tests/ElBruno.LocalEmbeddings.src/Tests/LocalEmbeddingGeneratorTests.cs`
...
### Step 3 — Update `src/src/Samples/ConsoleApp/Program.cs`
...
### Step 4 — Update `src/src/Samples/HelloWorldAltModel/Program.cs`
...
- `src/src/Samples/RagChat/Program.cs` — simplify query embedding calls (`GenerateEmbeddingAsync(query)`)
- `src/src/Samples/RagOllama/Program.cs` — simplify if applicable
- `src/src/Samples/RagFoundryLocal/Program.cs` — simplify if applicable
...
### Step 9 — Update `src/src/Samples/README.md`
...
| `src/Tests/ElBruno.LocalEmbeddings.src/Tests/LocalEmbeddingGeneratorTests.cs` | **MODIFY** — add 7 tests |
| `src/src/Samples/ConsoleApp/Program.cs` | **MODIFY** |
| `src/src/Samples/HelloWorldAltModel/Program.cs` | **MODIFY** |
| `src/src/Samples/RagChat/Program.cs` | **MODIFY** |
| `src/src/Samples/RagOllama/Program.cs` | **AUDIT** |
| `src/src/Samples/RagFoundryLocal/Program.cs` | **AUDIT** |
| `README.md` | **MODIFY** |
| `docs/api-reference.md` | **MODIFY** |
| `docs/getting-started.md` | **MODIFY** |
| `src/src/Samples/README.md` | **MODIFY** |
...
4. `dotnet run --project src/src/Samples/ConsoleApp` — end-to-end check
