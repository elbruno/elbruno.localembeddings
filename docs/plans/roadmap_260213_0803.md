...
1. [Library Improvements](#library-improvements)
   ...
   - [03. GPU / Hardware Acceleration (DirectML, CUDA)](#03-gpu--hardware-acceleration-directml-cuda)
   - [05. Embedding Caching Middleware](#05-embedding-caching-middleware)
   - [08. Model Integrity Verification (SHA256)](#08-model-integrity-verification-sha256)
   - [15. Cross-Platform Native Runtime Reliability (Linux ARM64)](#15-cross-platform-native-runtime-reliability-linux-arm64)
   - [20. ✅ ElBruno.LocalEmbeddings.ImageEmbeddings Library](#20--elbrunolocalembeddingsimageembeddings-library)
   - [01. ✅ Multi-TFM Support (net8.0 + net10.0)](#01--multi-tfm-support-net80--net100)
   - [02. ✅ SIMD / TensorPrimitives for Similarity & Normalization](#02--simd--tensorprimitives-for-similarity--normalization)
   - [04. ✅ Microsoft.Extensions.VectorData Integration](#04--microsoftextensionsvectordata-integration)
   - [06. ✅ True Async Model Loading](#06--true-async-model-loading)
   - [07. ✅ Quantized Model Support (INT8 / ONNX QDQ)](#07--quantized-model-support-int8--onnx-qdq)
   - [14. ✅ Single-String Convenience API (DX)](#14--single-string-convenience-api-dx)
   - [17. ✅ Dev Container Support (VS Code)](#17--dev-container-support-vs-code)
   - [18. ✅ Issue #24 Reliability, DX & Test Coverage Sweep](#18--issue-24-reliability-dx--test-coverage-sweep)
   - [19. ✅ Improvement Scenarios 1 & 2 (InMemoryVectorStore + FindClosest API)](#19--improvement-scenarios-1--2-inmemoryvectorstore--findclosest-api)

2. [New Samples](#new-samples)
   - [10. AspNetApiSample — Embedding Microservice](#10-aspnetapisample--embedding-microservice)
   - [13. MAUISample — Desktop / Mobile Semantic Note Search](#13-mauisample--desktop--mobile-semantic-note-search)
   - [09. ✅ VectorDataSample — Microsoft.Extensions.VectorData](#09--vectordatasample--microsoftextensionsvectordata)
   - [11. ✅ BenchmarkSample — BenchmarkDotNet Performance Suite](#11--benchmarksample--benchmarkdotnet-performance-suite)
   - [16. ✅ RaspberryPiTiny — Ultra-Small Stability Sample](#16--raspberrypitiny--ultra-small-stability-sample)
...
### 03. GPU / Hardware Acceleration (DirectML, CUDA)
...
### 05. Embedding Caching Middleware
...
### 08. Model Integrity Verification (SHA256)
...
### 15. Cross-Platform Native Runtime Reliability (Linux ARM64)

**Priority:** High | **Effort:** Low-Medium | **Impact:** High  
**Status:** Planned  
**Plan:** [plan_260213_1130.md](plan_260213_1130.md)

**Problem:** `src/src/Samples/ConsoleApp` can fail on Linux ARM64 with ONNX Runtime native library load errors (`DllNotFoundException`) while Windows scenarios continue to work.
...
### 01. ✅ Multi-TFM Support (net8.0 + net10.0)

**Priority:** High | **Effort:** Low | **Impact:** Very High | **Status:** ✅ Completed (2026-02-14)  
**Plan:** [plan_260214_2136_done.md](plan_260214_2136_done.md)
...
- [x] **File:** `src/Tests/ElBruno.LocalEmbeddings.src/Tests/ElBruno.LocalEmbeddings.Tests.csproj`
  - Targeted both TFMs so tests run on both.
- [x] **File:** `src/Tests/ElBruno.LocalEmbeddings.KernelMemory.src/Tests/ElBruno.LocalEmbeddings.KernelMemory.Tests.csproj`
  - Applied same TFM change.
...
### 02. ✅ SIMD / TensorPrimitives for Similarity & Normalization

**Priority:** High | **Effort:** Low | **Impact:** Medium | **Status:** ✅ Completed (2026-02-14)  
**Plan:** [plan_260214_2151_done.md](plan_260214_2151_done.md)
...
- [x] **File:** `src/Tests/ElBruno.LocalEmbeddings.src/Tests/EmbeddingExtensionsTests.cs`
...
### 04. ✅ Microsoft.Extensions.VectorData Integration

**Priority:** High (ecosystem alignment) | **Effort:** Medium | **Impact:** High
**Status:** ✅ Completed (2026-02-14)  
**Plan:** [plan_260214_2214_done.md](plan_260214_2214_done.md)
...
- [x] **New tests project:** `src/Tests/ElBruno.LocalEmbeddings.VectorData.Tests`
...
### 06. ✅ True Async Model Loading

**Priority:** Medium | **Effort:** Low | **Impact:** Medium | **Status:** ✅ Completed (2026-02-14)  
**Plan:** [plan_260214_0351_done.md](plan_260214_0351_done.md)
...
- [x] **File:** `src/Tests/ElBruno.LocalEmbeddings.src/Tests/LocalEmbeddingGeneratorTests.cs`
...
### 07. ✅ Quantized Model Support (INT8 / ONNX QDQ)
...
- [x] **File:** `src/Tests/ElBruno.LocalEmbeddings.src/Tests/ModelDownloaderTests.cs`
...
### 14. ✅ Single-String Convenience API (DX)

**Priority:** High | **Effort:** Low | **Impact:** High | **Status:** ✅ Completed (2026-02-13)  
**Plan:** [plan_260213_0913_done.md](plan_260213_0913_done.md)
...
- **Tests:** 7 new tests in `src/Tests/ElBruno.LocalEmbeddings.src/Tests/LocalEmbeddingGeneratorTests.cs`
...
### 17. ✅ Dev Container Support (VS Code)

**Priority:** High | **Effort:** Low | **Impact:** High | **Status:** ✅ Completed (2026-02-14)  
**Plan:** [plan_260213_1946_done.md](plan_260213_1946_done.md)
...
### 18. ✅ Issue #24 Reliability, DX & Test Coverage Sweep

**Priority:** High | **Effort:** Medium | **Impact:** High | **Status:** ✅ Completed (2026-02-14)  
**Plan:** [plan_260214_1021_done.md](plan_260214_1021_done.md)
...
- [x] **Test coverage expansion**
  - **New files:**
    - `src/Tests/ElBruno.LocalEmbeddings.KernelMemory.src/Tests/LocalEmbeddingTextGeneratorTests.cs`
    - `src/Tests/ElBruno.LocalEmbeddings.src/Tests/ServiceCollectionExtensionsTests.cs`
    - `src/Tests/ElBruno.LocalEmbeddings.src/Tests/OnnxEmbeddingModelTests.cs`
...
### 19. ✅ Improvement Scenarios 1 & 2 (InMemoryVectorStore + FindClosest API)

**Priority:** High | **Effort:** Medium | **Impact:** High | **Status:** ✅ Completed (2026-02-14)  
**Plan:** [plan_260214_1133_done.md](plan_260214_1133_done.md)
...
- [x] **Test coverage and docs updates**
  - **Files:**
    - `src/Tests/ElBruno.LocalEmbeddings.src/Tests/EmbeddingGeneratorFindClosestTests.cs`
    - `src/Tests/ElBruno.LocalEmbeddings.src/Tests/EmbeddingExtensionsTests.cs`
    - `src/Tests/ElBruno.LocalEmbeddings.VectorData.src/Tests/InMemoryVectorStoreTests.cs`
    - `src/Tests/ElBruno.LocalEmbeddings.VectorData.src/Tests/ServiceCollectionExtensionsTests.cs`
    - `README.md`, `docs/getting-started.md`, `docs/api-reference.md`, `docs/vector-data-integration.md`, `src/src/Samples/ConsoleApp/Program.cs`
...
### 10. AspNetApiSample — Embedding Microservice
...
**Location:** `src/src/Samples/AspNetApiSample/`
...
### 13. MAUISample — Desktop / Mobile Semantic Note Search
...
**Location:** `src/src/Samples/MAUISample/`
...
### 09. ✅ VectorDataSample — Microsoft.Extensions.VectorData

**Priority:** High | **Effort:** Medium | **Impact:** High | **Status:** ✅ Completed (2026-02-14)  
**Plan:** [plan_260214_1133_done.md](plan_260214_1133_done.md)

> **Note:** This sample was fulfilled by the built-in `InMemoryVectorStore` implemented in item #19 (Improvement Scenarios 1 & 2 — InMemoryVectorStore + FindClosest API). A separate standalone sample is no longer needed since the in-memory vector store and semantic search functionality are now part of the core `ElBruno.LocalEmbeddings.VectorData` package and demonstrated in the existing `ConsoleApp` sample.
...
**Location:** `src/src/Samples/VectorDataSample/`
...
### 11. ✅ BenchmarkSample — BenchmarkDotNet Performance Suite

**Priority:** Medium | **Effort:** Low | **Impact:** Medium | **Status:** ✅ Completed (2026-02-14)  
**Plan:** [plan_260214_0759_done.md](plan_260214_0759_done.md)
...
**Location:** `src/src/Samples/BenchmarkSample/`

**Implementation details (completed):**

- [x] **File:** `src/src/Samples/BenchmarkSample/BenchmarkSample.csproj` — Console project referencing BenchmarkDotNet 0.14.0 + main library.
- [x] **File:** `src/src/Samples/BenchmarkSample/Program.cs` — `BenchmarkSwitcher` entry point.
- [x] **File:** `src/src/Samples/BenchmarkSample/EmbeddingBenchmarks.cs` — Single-text and batch (10/50/100) embedding throughput with `[MemoryDiagnoser]`.
- [x] **File:** `src/src/Samples/BenchmarkSample/SimilarityBenchmarks.cs` — Cosine similarity (384/768-dim) and `FindClosest` (100/1000 corpus) benchmarks.
- [x] **File:** `src/src/Samples/BenchmarkSample/TokenizerBenchmarks.cs` — Short text, long text, and batch (10/50) tokenization benchmarks.
- [x] **File:** `src/src/Samples/BenchmarkSample/README.md` — Run instructions and baseline strategy.
- [x] **File:** `src/src/Samples/BenchmarkSample/baselines/README.md` — Cross-platform baseline capture/comparison workflow.
- [x] Added to `ElBruno.LocalEmbeddings.slnx`.
- [x] Updated `src/src/Samples/README.md` with BenchmarkSample entry.
...
### 16. ✅ RaspberryPiTiny — Ultra-Small Stability Sample
...
**Location:** `src/src/Samples/RaspberryPiTiny/`
...
- `src/src/Samples/RaspberryPiTiny/RaspberryPiTiny.csproj`
- `src/src/Samples/RaspberryPiTiny/Program.cs`

---

### 20. ✅ ElBruno.LocalEmbeddings.ImageEmbeddings Library

**Priority:** High | **Effort:** Medium | **Impact:** High | **Status:** ✅ Completed (2026-02-16)  
**Plan:** [plan_260216_1421_done.md](plan_260216_1421_done.md)

**Problem:** A standalone CLIP-based multimodal search prototype existed, but the CLIP encoding components were not reusable as a library. Developers had to copy code to use CLIP image embeddings in their own applications.

**Proposal:** Extract and productionize the CLIP image/text encoding into a companion library `ElBruno.LocalEmbeddings.ImageEmbeddings` following the established companion package pattern.

**Implementation details (completed):**

- [x] **New library:** `src/ElBruno.LocalEmbeddings.ImageEmbeddings/`
  - `ClipImageEncoder` — CLIP vision ONNX model, image preprocessing (resize 224×224, NCHW, CLIP normalization)
  - `ClipTextEncoder` — CLIP text ONNX model, BPE tokenization + text encoding
  - `ClipTokenizer` — BPE tokenizer with vocab.json + merges.txt support
  - `ImageSearchEngine` — Index images + text-to-image + image-to-image search via cosine similarity
  - `Options/ImageEmbeddingsOptions` — Configuration for model paths
  - `Extensions/ServiceCollectionExtensions` — DI registration via `AddImageEmbeddings(...)`
  - Multi-targets `net8.0;net10.0`

- [x] **Tests:** `src/Tests/ElBruno.LocalEmbeddings.ImageEmbeddings.src/Tests/`
  - Options validation, tokenizer encoding, DI argument validation

- [x] **Simple sample:** `src/src/Samples/ImageRagSimple/`
  - Minimal console app: load CLIP models → index images → search by text queries → display results

- [x] **Interactive chat sample:** `src/src/Samples/ImageRagChat/`
  - Rich Spectre.Console UI with text-to-image and image-to-image search
  - Interactive chat loop with help, commands, and formatted result tables

**Key files:**

- `src/ElBruno.LocalEmbeddings.ImageEmbeddings/ElBruno.LocalEmbeddings.ImageEmbeddings.csproj`
- `src/Tests/ElBruno.LocalEmbeddings.ImageEmbeddings.src/Tests/`
- `src/src/Samples/ImageRagSimple/Program.cs`
- `src/src/Samples/ImageRagChat/Program.cs`
...
|----------|------|--------|--------|--------------|-----------|
| **Medium** | 03. GPU / Hardware Acceleration (DirectML, CUDA) | Medium | High | None | No |
| **Medium** | 05. Embedding Caching Middleware | Medium | Medium | Check M.E.AI built-in support first | No |
| **Lower** | 08. Model Integrity Verification (SHA256) | Low | Low | None | No |
| **High** | 10. AspNetApiSample — Embedding Microservice | Low | High | None | No |
| **Lower** | 13. MAUISample — Desktop / Mobile Semantic Note Search | Medium | Medium | Multi-TFM (#01) helpful | No |
| **High** | 15. Cross-Platform Native Runtime Reliability (Linux ARM64) | Low-Medium | High | None | No |
| **High** | 01. ✅ Multi-TFM Support (net8.0 + net10.0) | Low | Very High | None | Yes |
| **High** | 02. ✅ SIMD / TensorPrimitives for Similarity & Normalization | Low | Medium | None (or after #01) | Yes |
| **High** | 04. ✅ Microsoft.Extensions.VectorData Integration | Medium | High | None | Yes |
| **Medium** | 06. ✅ True Async Model Loading | Low | Medium | None | Yes |
| **Medium** | 07. ✅ Quantized Model Support (INT8 / ONNX QDQ) | Medium | Medium | None | Yes |
| **High** | 09. ✅ VectorDataSample — Microsoft.Extensions.VectorData | Medium | High | None (uses existing API) | Yes |
| **Medium** | 11. ✅ BenchmarkSample — BenchmarkDotNet Performance Suite | Low | Medium | After #02 (to compare before/after SIMD) | Yes |
| **High** | 14. ✅ Single-String Convenience API (DX) | Low | High | None | Yes |
| **High** | 16. ✅ RaspberryPiTiny — Ultra-Small Stability Sample | Low | High | #15 helpful | Yes |
| **High** | 17. ✅ Dev Container Support (VS Code) | Low | High | None | Yes |
| **High** | 18. ✅ Issue #24 Reliability, DX & Test Coverage Sweep | Medium | High | None | Yes |
| **High** | 19. ✅ Improvement Scenarios 1 & 2 (InMemoryVectorStore + FindClosest API) | Medium | High | #04 VectorData Integration | Yes |
| **High** | 20. ✅ ElBruno.LocalEmbeddings.ImageEmbeddings Library | Medium | High | None | Yes |

### Suggested implementation order

1. **Next features/samples:**
   - #03 GPU / Hardware Acceleration (DirectML, CUDA)
   - #05 Embedding Caching Middleware
   - #08 Model Integrity Verification (SHA256)
   - #10 AspNetApiSample — Embedding Microservice
