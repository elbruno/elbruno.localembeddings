# Plan — Add Parameterless LocalEmbeddingGenerator Constructor ✅ DONE
...
2. **Tests** (`src/Tests/ElBruno.LocalEmbeddings.src/Tests/LocalEmbeddingGeneratorTests.cs`)
...
3. **Samples**
   - Update `src/src/Samples/RagFoundryLocal/Program.cs`:
